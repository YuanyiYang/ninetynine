...
public final class GameApi {
  ...
  public static class EndGame extends Operation {
    ...
    /*
     * This is for the player who won the first time of the game. What about the second time?
     * ?????????????????
     */
  ...
  /*
   * This Set operation only assigns the card to the player. Have nothing to do with the 
   * visiblity operation.
   */
  ...
  /*
   * The key here should be the same with the key in the Set operation. In the card game, ie
   * Cx to represent the card. The object visibleToPlayerIds should also be the same.
   */
  ...
  /*
   * Here I deem it as the operation to determine how long the player should make a move.
   */
  ...
  /*
   * I deem it as the operation to delete the entry of a certain key in the state.
   */
  ...
  /*
   * No hacker, use the default constructor. Otherwise use the constructor with the hacker Id.
   */
